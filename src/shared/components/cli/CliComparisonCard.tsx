          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-1 flex-wrap">
                ...
                {isCurrent ? (
                  <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 text-[10px] font-medium rounded-full bg-primary/10 text-primary whitespace-nowrap">
                    {t("comparison.thisPage")} ✓
                  </span>
                ) : (
                  <Link
                    href={TYPE_HREFS[type]}
                    className="inline-flex items-center px-1.5 py-0.5 text-[10px] font-medium rounded-full bg-bg-subtle text-text-muted hover:text-text-main hover:bg-border transition-colors whitespace-nowrap"
                  >
                    {t("comparison.open")}
                  </Link>
                )}
