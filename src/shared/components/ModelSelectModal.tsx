      ...
      <div className="mb-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 bg-surface border border-border-strong rounded-control text-xs placeholder:text-text-subtle focus:outline-none focus:ring-1 focus:ring-focus/50"
          />
        </div>
      </div>
