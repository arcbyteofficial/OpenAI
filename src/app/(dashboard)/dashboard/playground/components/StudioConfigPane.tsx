      ...
      <div className="flex flex-col gap-5 p-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <select
            ...
            className="w-full text-xs bg-surface border border-border-strong rounded-control px-2 py-1.5 placeholder:text-text-subtle focus:outline-none focus:ring-1 focus:ring-focus text-text-main"
          >
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            rows={4}
            className="w-full text-xs bg-surface border border-border-strong rounded-control px-2 py-1.5 placeholder:text-text-subtle focus:outline-none focus:ring-1 focus:ring-focus text-text-main resize-y"
          />
