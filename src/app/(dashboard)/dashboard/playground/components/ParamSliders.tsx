    ...
    <div className="flex flex-col gap-1">
      <div className="flex items-center justify-between">
        ...
        <input
          ...
          className="w-16 text-xs text-right font-mono tabular-nums bg-surface border border-border-strong rounded-control px-1.5 py-0.5 focus:outline-none focus:ring-1 focus:ring-focus"
        />
      </div>
      <input
        type="range"
    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          className="w-full text-xs bg-surface border border-border-strong rounded-control px-2 py-1.5 placeholder:text-text-subtle focus:outline-none focus:ring-1 focus:ring-focus"
        />
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-focus/30 ${
