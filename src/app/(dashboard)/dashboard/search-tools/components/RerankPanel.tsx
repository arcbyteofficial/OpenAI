          ...
          <>
            ...
            {reranked.length > 0 && (
              <div className="space-y-2">
                {reranked.map((r) => (
                  <div key={r.index} className="flex items-start gap-3 p-2 bg-bg-subtle rounded-lg">
                    <div className="flex flex-col items-center min-w-[32px]">
                      <span className="text-xs font-medium font-mono tabular-nums text-text-main">
                        #{r.index + 1}
                      </span>
                    ...
                    <span className="text-[10px] font-mono tabular-nums text-primary whitespace-nowrap">
                      {r.score.toFixed(4)}
                    </span>
                  </div>
                ))}
