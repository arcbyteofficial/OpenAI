      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-control border border-border-strong bg-surface px-3 py-1.5 text-[13px] font-medium text-text-main hover:bg-bg-subtle transition-colors"
          >
