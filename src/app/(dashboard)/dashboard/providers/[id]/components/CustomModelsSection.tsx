        ...
        <div className="flex items-end gap-2">
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full px-3 py-2 text-sm text-text-main border border-border-strong rounded-control bg-surface transition-colors focus:outline-none focus:border-focus"
            />
          </div>
          <div className="w-40">
                      ...
                      <div className="flex min-w-0 flex-wrap items-end gap-x-3 gap-y-2">
                        <div className="w-[11rem] shrink-0 min-w-0">
                          ...
                          <select
                            ...
                            className="w-full px-2.5 py-2 text-xs border border-border-strong rounded-control bg-surface text-text-main transition-colors focus:outline-none focus:border-focus"
                          >
                            <option value="chat-completions">{t("chatCompletions")}</option>
                            <option value="responses">{t("responsesApi")}</option>
                            <option value="embeddings">{t("embeddings")}</option>
