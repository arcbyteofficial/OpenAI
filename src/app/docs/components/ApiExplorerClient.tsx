            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-sm bg-bg-subtle border border-border rounded-lg focus:outline-none focus:ring-1 focus:ring-focus"
                />
              </div>
              <div>
            ...
            {selected.method !== "GET" && selected.hasRequestBody && (
              <div>
                ...
                <textarea
                  ...
                  rows={8}
                  className="w-full px-3 py-2 text-sm font-mono bg-bg-subtle border border-border rounded-lg focus:outline-none focus:ring-1 focus:ring-focus"
                />
              </div>
            )}
